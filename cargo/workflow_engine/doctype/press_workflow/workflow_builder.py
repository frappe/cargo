...
if TYPE_CHECKING:
	from cargo.workflow_engine.doctype.press_workflow.press_workflow import PressWorkflow
	from cargo.workflow_engine.doctype.press_workflow_task.press_workflow_task import (
		PressWorkflowTask,
	)
...
class WorkflowBuilder(Document):
	...
	def on_trash(self) -> None:
		...
		for name in frappe.get_all(
			...
			frappe.delete_doc("Press Workflow", name, ignore_permissions=True, delete_permanently=True)
