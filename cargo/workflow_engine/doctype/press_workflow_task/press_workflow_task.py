...
from cargo.workflow_engine.doctype.press_workflow.press_workflow import enqueue_workflow
from cargo.workflow_engine.doctype.press_workflow_object.press_workflow_object import (
	PressWorkflowObject,
)
from cargo.workflow_engine.utils import calculate_duration, deserialize_value, serialize_and_store_value
...
def enqueue_task(task_name: str) -> None:
	if frappe.flags.in_test:
		from cargo.workflow_engine.test_utils import foreground_enqueue_task
